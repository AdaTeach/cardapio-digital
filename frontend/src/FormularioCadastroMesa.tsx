...
export function FormularioCadastroMesa() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            if (!r.ok) {
                setErro('Erro ao cadastrar mesa.');
                return;
            }

            setSucesso(true);
            setForm({ numero: '', capacidade: '', status: 'disponivel' });
        ...
        <div style={styles.page}>
            ...
            <main style={styles.main}>
                <div style={styles.card}>
                    <h2 style={styles.title}>Cadastro de Mesa</h2>

                    {sucesso && <p style={styles.sucesso}>Mesa cadastrada com sucesso! Redirecionando...</p>}
